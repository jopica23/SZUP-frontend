    ...
    useEffect(() => {
            ...
            const fetchProject = async () => {
                ...
                try {
                    ...
                    setUserRights(response.data.userRightsResponseDTO) //moguci issue
                } catch (error) {
                ...
                <br />
                {
                    userRights.canModifyTeam ? (
                        <div>
                            ...
                            <Team key={project.teamLeaderOf.teamName} team={project.teamLeaderOf} canModify={true} projectId={id} userId={currUser}/>
                        </div>
                    ) : (
