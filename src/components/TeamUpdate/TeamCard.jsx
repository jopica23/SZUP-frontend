...
export default function TeamCard({team, projectId, userId}) {
        ...
        <div className="max-w-sm m-2 rounded overflow-hidden shadow-xl">
            <div className="block rounded-lg text-center shadow-secondary-1 text-surface">
                ...
                <div
                    ...
                    <label htmlFor="countries" className="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Odaberi
